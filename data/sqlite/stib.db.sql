...
CREATE TABLE IF NOT EXISTS `FAVORITES` (
                                           `name_favorite` TEXT NOT NULL,
                                           `id_station_source` INTEGER NOT NULL,
                                           `id_station_destination` INTEGER NOT NULL,
                                           PRIMARY KEY(`name_favorite`),
    FOREIGN KEY(`id_station_source`) REFERENCES `STATIONS`(`id`),
    FOREIGN KEY(`id_station_destination`) REFERENCES `STATIONS`(`id`)
    );
